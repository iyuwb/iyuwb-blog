                ...
                },
                {
                    ...
                    sidebar: [
                        ...
                        },
                        {
                            ...
                            items: ['JavaScript-Event Loop','JavaScript-ES与CommonJS','JavaScript-作用域和闭包', 'JavaScript-ECMAScript1-4', 'JavaScript-ECMAScript5', 'JavaScript-ECMAScript6', 'JavaScript-ECMAScript7', 'JavaScript-ECMAScript8', 'JavaScript-ECMAScript9', 'JavaScript-ECMAScript10', 'JavaScript-ECMAScript11', 'JavaScript-ECMAScript12', 'JavaScript-ECMAScript13']
                        },
                        {
                            text: 'JavaScript问题',
                            icon: 'icon-park-outline:file-question',
                    ...
                    sidebar: [
                        {
                            ...
                            items: ['TypeScript-简介安装','TypeScript-类型相关','TypeScript-命令方法', 'TypeScript-基础数据类型', 'TypeScript-特有数据类型', 'TypeScript-any与unknown', 'TypeScript-never与void', 
                                'TypeScript-数组与元组', 'TypeScript-函数', 'TypeScript-对象',  'TypeScript-接口（Interface）', 'TypeScript-类（Class）','TypeScript-泛型','TypeScript-模块']
                        },
                        {
                            text: 'TypeScript方案',
                            icon: 'icon-park-outline:plan',
